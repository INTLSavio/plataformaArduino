...
class UserController{
   ...
   async index(req, res){
        ...
        var Reg = 'Regular'
        try{
            var confrontosTec = await AdminService.confrontosIndex(Tec)
            var confrontosReg = await AdminService.confrontosIndex(Reg)
            res.render('user/index', {confrontosReg:confrontosReg, confrontosTec:confrontosTec});
        }catch(err){
